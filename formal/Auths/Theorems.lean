...
def theoremInventory : List Lean.Name :=
  [
    ...
    `Auths.Rich.extensions_le_false_of_stripped,
    `Auths.Rich.extensions_le_false_of_refused,
    `Auths.Rich.extensions_le_false_of_refused_addition,
    `Auths.Rich.extensions_le_refuses_a_dropped_singleton,
    `Auths.Rich.extensions_le_narrows,
    ...
    `Auths.Rich.extensions_dimension_false_of_stripped,
    `Auths.Rich.altered_extensions_deny_every_projection,
    `Auths.Rich.delegate_attenuates_pinned_extensions,
    `Auths.Rich.chain_retains_pinned_extension_identifiers,
    `Auths.Rich.delegate_never_widens_authority,
    `Auths.Rich.chain_never_widens_authority,
    ...
    `Auths.Rich.Mutations.critical_extension_law,
    ...
    `Auths.Observation.fresh_monotone_max_age,
    `Auths.Observation.narrows_monotone,
    `Auths.Observation.covers_monotone,
    `Auths.Observation.covers_trans,
    `Auths.Observation.requirements_attenuate_refl,
    `Auths.Observation.requirements_attenuate_trans,
