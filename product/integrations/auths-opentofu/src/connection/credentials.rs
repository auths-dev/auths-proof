use super::descriptor::OpenTofuConnectionDescriptor;
...
/// Static OpenTofu backend connection adapter.
pub struct OpenTofuConnectionAdapter {
    descriptors: RwLock<BTreeMap<[u8; 32], OpenTofuConnectionDescriptor>>,
}

impl OpenTofuConnectionAdapter {
...
impl Default for OpenTofuConnectionAdapter {
    fn default() -> Self {
        Self::new()
    }
}
...
#[async_trait]
impl ProviderConnectionAdapter for OpenTofuConnectionAdapter {
    ...
    fn validate_descriptor(
        ...
        let descriptor = OpenTofuConnectionDescriptor::from_canonical_bytes(bytes)?;
    ...
    fn permits_scope(
        ...
        let parsed = OpenTofuConnectionDescriptor::from_canonical_bytes(descriptor.bytes())?;
