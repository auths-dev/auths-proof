...
def read_derivation_record_v1(record: bytes) -> str: ...
...
class PortableReceiptProjection:
    @property
    def portable_receipt_id(self) -> str: ...
    @property
    def kind(self) -> str: ...
    @property
    def decision_receipt_id(self) -> bytes: ...
    @property
    def execution_receipt_id(self) -> Optional[bytes]: ...
    @property
    def attested_decision(self) -> bytes: ...
    @property
    def attested_execution(self) -> Optional[bytes]: ...
...
def validate_receipt_anchor_v1(suite: str, public_key: bytes) -> None: ...
def profile_receipt_payload_commitment_v2(kind: str, payload: bytes) -> bytes: ...
def decode_portable_receipt_v1(value: bytes) -> PortableReceiptProjection: ...
def verify_pinned_receipt_v1(
    kind: str,
    attested: bytes,
    expected_id: bytes,
    verifier: str,
...
class ReviewedApprovalRequest:
    ...
    def prepare_approval(
        self, signer: str, principal_method: str, verification_method: str, suite: str
    ) -> PendingApproval: ...
    def prepare_decline(
        self,
        signer: str,
...
def project_sdk_event_json_v2(input: str) -> str: ...
