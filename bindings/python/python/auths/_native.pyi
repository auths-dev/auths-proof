...
def production_client_contract_version_v1() -> int: ...
def encode_production_request_v1(
    verb: str,
    profile: str,
    identity: bytes,
    authority: Optional[bytes],
    body: Optional[bytes],
    recovery_reference: Optional[str],
) -> bytes: ...
def decode_production_response_v1(input: bytes) -> str: ...
def decode_production_request_v1(input: bytes) -> str: ...
def encode_production_delegation_v1(subject: bytes, attenuation: bytes) -> bytes: ...
