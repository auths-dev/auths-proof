...
REQUIRED_PACKAGE_FILES = {
    ...
    "auths/_mechanism_conformance_v2.py",
    "auths/_mechanisms.py",
    "auths/_observability.py",
    "auths/_plan.py",
    "auths/_profile_cli.py",
    ...
    "auths/_trust.py",
    "auths/_workflow.py",
    "auths/adapters/__init__.py",
    "auths/adapters/custody.py",
    "auths/adapters/reservations.py",
    "auths/attempts.py",
    "auths/authoring.py",
    "auths/execution.py",
    "auths/identity/__init__.py",
    "auths/identity/adapters.py",
    "auths/identity/authoring.py",
    "auths/protocol.py",
    "auths/profile_runtime.py",
    "auths/py.typed",
    "auths/self_hosted.py",
    "auths/testkit.py",
    "auths/verify.py",
}
