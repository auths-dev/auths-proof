...
use auths_model::{
    ...
    MediaType, ModelError, ObservationStatement, PermissionSet, PrincipalId, PrincipalStatusId,
    PrincipalStatusStatement, ProfileRef, ProofBundle, ProofRef, ResourceId, ScopeAuthorityView,
    SignatureBytes, SignatureDescriptor, SignatureEnvelope, SignedAction, SignedGrant,
