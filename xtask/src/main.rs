    ...
    match command.as_str() {
        "ci" => {
            ...
            match arguments.as_slice() {
                ...
                _ => Err(format!(
                    "unknown CI phase {}; expected authoritative, formal-translation, formal-post-qualification, or compliance",
                    arguments.join(" ")
                )),
            }
        }
...
mod tests {
    ...
    fn invalid_ci_phase_preserves_error_contract() {
        ...
        assert_eq!(
            error,
            "unknown CI phase unknown; expected authoritative, formal-translation, formal-post-qualification, or compliance"
        );
    }
}
