...
use auths_kubernetes::{KubernetesRolloutProfile, KubernetesWorkloadRolloutV1};
use auths_model::{
...
pub fn authorization_fixture(
    ...
    .unwrap();
    let namespace = format!("kubernetes://{}", action.cluster_audience());
...
mod tests {
    ...
    #[test]
    fn exact_rollout_is_authorized_by_real_auths_kernel() {
        let fixture = auths_kubernetes::test_support::fixture();
        let auth = authorization_fixture(&fixture.action, fixture.now, [0x97; 32]);
        let canonical = KubernetesRolloutProfile
