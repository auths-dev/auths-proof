...
function render(receipt) {
  ...
  elements.title.textContent = authorized ? "The exact rollout was authorized." : "The rollout was denied before an unauthorized effect.";
  ...
  if (decision) {
    ...
    addFact(facts, "Kubernetes called", String(result.kubernetes_called));
