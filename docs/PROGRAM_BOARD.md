...
| 0057 Epic 2 — gateway + hostile proof | `codex/developer-profile-gateway` | in progress; live mechanical gateway path, still unqualified | [Draft PR #125](https://github.com/auths-dev/auths-proof/pull/125) contains three SDK-generated recipe fixtures, compiler, one-use claim store, native-verification coordinator, customer-operated service, and Python/TypeScript proof-action clients. Local packaged-wheel runs reached an [Airtable record](https://airtable.com/appQD3Qf0YFBCW9bV/tblHscC7D9Kp7hiRw/viw8KMXQZw8bd3XXJ/recc20fysorU22tQT) and a [Todoist task](https://app.todoist.com/app/task/6hXvvMxXRrmpR7Rm); the ledger records same-UID, testkit-trust, and causation limits. [Hosted run 35683281231](https://github.com/auths-dev/auths-proof/actions/runs/35683281231) found a Windows Unix-socket test, and [run 35683281298](https://github.com/auths-dev/auths-proof/actions/runs/35683281298) found Python 3.9 typing incompatibilities. This commit corrects both and an async-client panic seen live. | Obtain hosted green, isolate a distinct app UID, and exercise hostile cases; external adoption remains open. |
