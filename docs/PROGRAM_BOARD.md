...
| 2026-09-21 | Epic 4 hosted CI | PR #124 targets the Epic 1 branch while automatic CI workflows target PRs against `main`; a manual exact-ref dispatch would still require restored Actions billing. | Left PR #124 draft and exact-ref CI not checked; did not retarget to `main` or claim green. |
