...
| --- | --- | --- | --- | --- |
| 0057 Epic 1 — freeze on evidence | codex session on `codex/self-hosted-developer-profiles` | blocked on field-lab hosted CI; not done | Commit `da5f470` is green in [CI](https://github.com/auths-dev/auths-proof/actions/runs/35650010786), [Python package](https://github.com/auths-dev/auths-proof/actions/runs/35650010520), [TypeScript package](https://github.com/auths-dev/auths-proof/actions/runs/35650010653), and [ten recipes](https://github.com/auths-dev/auths-proof/actions/runs/35650010580). Field-lab commit `7ecea03` pins that exact SDK revision and removes the obsolete checkout token. Both demo workflows and Tier 0 never started because `auths-field-lab` remains private and the account still blocks paid Actions minutes; this is a new billing blocker, not an SDK test failure. `9b31882` is corrected forward in the claim ledger. | Will the owner enable field-lab hosted jobs (billing/spending limit or public visibility) so both demo workflows can actually run? |
