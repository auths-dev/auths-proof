...
**Depends on:** Content Epics 10–11 and the seven qualified scenarios.

## Outcome

A new reader chooses a path, runs a real cross-language example, observes one
success and one fail-closed outcome, and knows where to continue.
...
- No Get started page is a dead end or an orphan.
